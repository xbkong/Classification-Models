...
def conv_bn_relu(x, num_filters, kernel_size, strides=(1, 1), padding='same', use_bias=False):
    """
    Basic conv - bn - relu block
    """
    x = Conv2D(num_filters, kernel_size, strides=strides, padding=padding, use_bias=use_bias)(x)
...
def inception_base(inp):
    """
    First few layers of Inception V4
    """
...
def inception_v4(input_shape, output_classes=1001, include_top_layer=False, dropout_prob=0.5):
    """
    Specification of the Inception V4 architecture
